#[cfg(test)]
mod phase4_tests {
    use crate::biosphere::immune::{HdcAnomalyDetector, Hypervector};
    use crate::noosphere::tensegrity::IsingTensegrityOptimizer;
    ...
    fn test_hdc_anomaly_detection() {
        ...
        let normal_samples = vec![(10.0, 0.1, 0.2), (11.0, 0.1, 0.2), (10.5, 0.15, 0.2)];
    ...
    fn test_surface_code_healing() {
        use crate::logos::cipher::TopologicalSurfaceCode;
        ...
        // Inject a network erasure (dropped packet chunk)
        lattice[1][1] = 0;
