...
@pytest.fixture
def run_origin_core():
    """Fixture that provides a function to run the main.py script with given arguments."""
...
@pytest.fixture
def parse_logs():
    """Fixture that provides a function to parse logs from stdout. Handles JSON or key=value regex."""
